...
module "fileshare" {
  ...
  #key_name                  = azurerm_key_vault_key.fileshare.name
  #keyvault_id               = module.keyvault.id
  #delete_retention_policy   = var.fileshare.delete_retention_policy
...
module "firewall" {
  source = "./modules/terraform-azurerm-firewall"
...
module "traffic_manager" {
  source = "./modules/terraform-azurerm-traffic-manager"
...
module "dns_zones" {
    source = "./modules/terraform-azurerm-dns_zones"
...
module "cognitive_account" {
    source = "./modules/terraform-azurerm-cognitive_account"
